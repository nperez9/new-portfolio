      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            exit={{ x: -200 }}
            className="px-6  z-[100] py-10 bg-stone-800 text-stone-200 max-w-[14rem] lg:w-fit  fixed lg:relative  h-screen left-0 flex flex-col justify-between"
          >
  ...
  return (
    <div className="flex space-x-2">
      ...
      <div className="flex text-sm flex-col">
        <p className="font-bold text-primary">Nicolas Perez</p>
